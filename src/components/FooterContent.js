...
const FooterContent = ({ className = "" }) => {
  return (
    <div
      className={`w-[1059px] flex flex-row items-start justify-between max-w-full gap-[20px] text-left text-base text-black font-roboto lg:flex-wrap ${className}`}
    >
      <div className="w-[141px] flex flex-col items-start justify-start pt-2.5 px-0 pb-0 box-border text-8xs-2 text-gray-300">
        <div className="self-stretch flex flex-col items-start justify-start gap-[35px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[16px] text-base text-black">
            <div className="relative leading-[26px] capitalize font-medium whitespace-nowrap z-[8]">
              help@frybix.com
            </div>
            <div className="relative leading-[26px] capitalize font-medium whitespace-nowrap z-[8]">
              +1 234 456 678 89
      ...
      <div className="flex flex-col items-start justify-start gap-[16px]">
        ...
        <div className="relative leading-[26px] capitalize font-medium inline-block min-w-[106px] z-[8]">
          terms of use
        </div>
      ...
      <div className="w-[340px] flex flex-col items-start justify-start gap-[16px] max-w-full">
        ...
        <div className="relative leading-[26px] capitalize font-medium inline-block min-w-[122px] z-[8]">
          Stay up to date
        </div>
        <div className="self-stretch shadow-[-13px_13px_104.09px_rgba(161,_161,_161,_0.1)] rounded bg-white flex flex-row items-start justify-between py-2.5 pr-2.5 pl-6 box-border max-w-full gap-[20px] z-[8] text-gray-200 mq450:flex-wrap">
          ...
          <div className="rounded bg-black flex flex-row items-start justify-start pt-[18px] px-10 pb-[17px] z-[1] text-white">
            <div className="h-[61px] w-40 relative rounded bg-black hidden" />
            <div className="relative leading-[26px] capitalize font-medium inline-block min-w-[80px] z-[1]">
              Subscribe
            </div>
          </div>
        </div>
